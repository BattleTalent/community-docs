...
* Modify field `Product Name` to your new mod name.
...
* Modify field `Prefix` to your new prefix name. Use the format: `YOURPREFIX_`.
**Note:** The prefix used in the tutorial is "WMD\_". You will need to fill in your new prefix instead of every "WMD\_" in the tutorial. 
