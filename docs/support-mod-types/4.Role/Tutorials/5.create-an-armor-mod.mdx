...
3. Save broken prefab:
   ...
   - Save broken armor as a prefab here,  `rename the prefab exactly the same as the corresponding armor GameObject in your character prefab`
...
1. Setup profile:
   ...
   - Rename the profile appropriately
     ...
     <img src="5.create-an-armor-mod/create-armor-profile.png" style="zoom:70%;" />
...
2. Configure settings:
   ...
   - **stiffSec** (optional): Set stun duration when armor breaks
     ...
     <img src="5.create-an-armor-mod/fill-armor-profile.png">
...
<img src="5.create-an-armor-mod/assign-armor-profile.png">
