...
* Rename the config file to match your character name
  ...
  <img src="4.create-a-role-mod/create-itemInfoConfig.png" style="zoom:50%;" />

* Click the `+` button in the `RoleModInfo` section to create character configuration

  <img src="4.create-a-role-mod/add-role-mod-info.png" style="zoom:60%;" />
...
<img src="4.create-a-role-mod/replace-all-characters.png" style="zoom:60%;" />
