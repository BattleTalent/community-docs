...
* Adjust the `Transform`'s `Y` value to change the position of the [DeadZone](../details/deadzone-respawntrigger.md) (under `SceneScriptNode`).
* Place [RespawnTrigger](../details/deadzone-respawntrigger.md)'s to place respawn points.
