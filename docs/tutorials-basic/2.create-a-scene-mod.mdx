...
* Place the SceneScriptNode, set the CharacterPos under the SceneScriptNode to adjust the character generation position.
![](2.create-a-scene-mod/sceneScriptNode.png)
* Set the height of the [DeadZone](../details/deadzone-respawntrigger.md) under the `SceneScriptNode` and place the  [RespawnTrigger](../details/deadzone-respawntrigger.md)  respawn point
![](2.create-a-scene-mod/pathfinder.png)
* Set the BoxCollider of the PathFinder under the SceneScriptNode to enclose the whole scene
* Save the scene.
